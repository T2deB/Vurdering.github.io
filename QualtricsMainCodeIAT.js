	...
	**/
	...
	function iatExtension(options)
	{
		...
		category2 :	{
			...
			'Hvis du gjør feil så vil en rød <font color="#ff0000"><b>X</b></font> dukke opp. ' +
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Legg venstre finger på <b>E</b> tasten for ting som tilhører kategorien <font color="#0000ff">leftAttribute.</font>' +
				'<br/>Legg høyre finger på <b>I</b> tasten for ting som tilhører kategorien <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				'Hvis du gjør feil så vil en rød <font color="#ff0000"><b>X</b></font> dukke opp. ' +
				'Trykk på den andre tasten for å fortsette.<br/>' +
				'<u>Vennligst gjennomfør det så raskt du kan</u> mens du er nøyaktig.<br/><br/></p>'+
			...
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Legg venstre finger på (sjekk hvordan dette ser ut i Qualtrics) <b>left</b> green area for items that belong to the category <font color="#0000ff">leftAttribute</font>.<br/>',
